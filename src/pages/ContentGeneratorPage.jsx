      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeTab === "image" && generatedImages.length > 0 && (
            <div className="bg-[#16111d]/60 border border-[#2a2235] rounded-2xl p-6 w-full max-w-full min-w-0">
              <h3 className="text-lg font-semibold text-[#a88fd8] mb-4">
                Generated Ad Images
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 items-stretch">
                {generatedImages.map((img, i) => (
                  <div
                    key={i}
                    className={`w-full min-w-0 h-full flex flex-col rounded-xl overflow-hidden border ${selectedImage?.provider === img.provider
                  ...
                  >
                    ...
                    <div className="bg-black/40 text-xs text-gray-300 p-2 text-center border-b border-[#2a2235]">
                      Generated by: <div className="text-[#a88fd8] font-medium">
